...
export const metadata: Metadata = {
  ...
  description: "Register to your account and start using the URL Shortener service.",
};
  ...
  return (
    <main className="flex-1 max-w-5xl mx-auto p-6 w-full">
      <section className="max-w-lg mx-auto p-6">
        <h1 className="text-4xl font-bold text-center text-gray-800 mb-2">Create an Account</h1>
