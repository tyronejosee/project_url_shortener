export default function PrivacyPolicy() {
  return (
    <main className="max-w-screen-lg mx-auto p-6">
      <section className="mx-auto p-8 rounded-lg border border-neutral-300">
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-700">
            This policy has been developed in accordance with the Federal Law
            No. 152-FZ &quot;On Personal Data&quot; dated July 27, 2006. It
            defines how we process personal data and ensures the protection of
            your data while using the URL Shortener service.
          </p>
          ...
          <ul className="list-inside list-disc text-gray-700">
            ...
            <li>
              <strong>Operator:</strong> The entity responsible for organizing
          ...
          <p className="text-gray-700">
            We may collect the following personal data: full name, email
            address, and anonymized data such as cookies. We use analytics
            services such as Yandex Metrica and Google Analytics to improve the
            service.
          </p>
          ...
          <p className="text-gray-700">
            ...
            website, with your consent. Anonymized data may also be processed
          ...
          <p className="text-gray-700">
            We will only transfer your data to foreign countries where your
          ...
          <p className="text-gray-700">
            ...
            processing of your personal data, feel free to contact us at{" "}
            <a
